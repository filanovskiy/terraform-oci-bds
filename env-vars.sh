...
export TF_VAR_bds_instance_cluster_admin_password=`echo -n 'Welcome1!'|openssl base64` # your Cloudera Manager password is Welcome1!
...
export TF_VAR_bds_cluster_name="bdsdemo"